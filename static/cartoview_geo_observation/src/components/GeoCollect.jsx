...
class GeoCollect extends Component {
    ...
    render( ) {
        ...
        const { xyValue, saving, currentComponent, attrsValue, file,parentComponent } =
        this.state
        return (
            <div className="row" style={{ paddingTop: 50, paddingBottom: 50 }}>
                <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div>
                        ...
                        <TopNav currentComponent={parentComponent} toggleComponent={x => this.setParentComponent(x)} />
                        {parentComponent==="geoCollect" && <div>
                        ...
                        {parentComponent==="featureList" && <FeatureList mapUrl={urls.mapJsonUrl} {...config.config} geoserverUrl={urls.geoserverUrl} />}
                    </div>
                </div>
            </div>
        )
