...
class FeatureList extends Component {
    ...
    render() {
        const { classes, imageSrc, title, description, files, comments, imageEnabled, match, editURL, location, featureId } = this.props
        ...
        return (
            <Paper className={classNames("element-flex", classes.paperPosition, "card-item")} elevation={4}>
                ...
                >
                    <MenuItem component={Link} to={`${location.pathname}${featureId}/details`}>
                        {"Open"}
                    </MenuItem>
